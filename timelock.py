...
class Timelock(object):
    ...
    Attributes
    ----------
    self.locked : a pandas DataFrame containing columns of trial information,
        trial timing information, and timelocked spike timestamps.  Rows are
        trials, columns are data.
